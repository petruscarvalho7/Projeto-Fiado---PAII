...
public class Client2 extends Activity {
  ...
  class Size extends AbstractCommand implements Command,
  Button.OnClickListener {
	  public void execute(Dao6 d) {
		  int size = d.size();
		  String text = "O número de estudantes é: " + size;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    ((Button) findViewById(R.id.size)).setOnClickListener(new Size());
