...
import com.example.projetofiado.negocio.VendaConverter;
import com.example.projetofiado.negocio.WebClient;
...
public class ActivityMain extends Activity {
	...
	public void telaNovaVenda() {
		...
		final EditText EditTextNomeVenda;

		EditTextNomeVenda = (EditText) findViewById(R.id.campoNome);
		lvProdutos = (ListView) findViewById(R.id.lvProdutos);
		...
		btAdd.setOnClickListener(new View.OnClickListener() {
			public void onClick(View arg0) {
				addNomeVenda( EditTextNomeVenda.getText().toString());
				
				if (produtosAdd.isEmpty()) {
					
					/*VendaConverter conversorJson = new VendaConverter();
					String json = conversorJson.toJSON(nomeVenda);
					
					WebClient client = new WebClient("http://ip.jsontest.com/");
					String resposta = client.Post(json);
					
					Toast to = Toast.makeText(ActivityMain.this, resposta, Toast.LENGTH_SHORT);
					to.show();*/
					...
					//Definindo o axcesso ao servidor web
					WebClient client = new WebClient("http://ip.jsontest.com/");
					String resposta = client.Post(json);
